...
function pack_video_stitch_demo() {
  ...
  echo "./\$1/video_stitch_demo $COMMON_PARAMS --max_batch=4 --bmodel=./yolov5s-640x640-int8-4b.bmodel --num=4 --skip=2 " >> $BIN_DIR
  cp $MODEL_PATH/yolov5s-640x640-int8-4b.bmodel ./release/video_stitch_demo
...
function pack_yolov5s_demo() {
  ...
  echo "./\$1/yolov5s_demo $COMMON_PARAMS --max_batch=4 --bmodel=./yolov5s-640x640-int8-4b.bmodel" >> $BIN_DIR
  cp $MODEL_PATH/yolov5s-640x640-int8-4b.bmodel ./release/yolov5s_demo
...
function pack_multi_demo() {
    ...
    cp $MODEL_PATH/yolov5s-640x640-int8-4b.bmodel ./release/multi_demo
...
pack_multi_demo
cp /data/others/*.docx release/
cp /data/others/face_demo-winx64.zip release/
