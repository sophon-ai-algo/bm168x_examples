...
{
  const char *keys="{bmodel | ../../data/models/BM1684/yolov7_640_v0.1_3output_fp32_1b.bmodel | bmodel file path}"
  ...
  ts.build_timeline("YoloV7");
  ts.show_summary("YoloV7 Demo");
  ts.clear();
