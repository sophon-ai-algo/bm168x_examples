...
$ ./yolo_test.pcie image imagelist.txt ${configs}/yolov4.cfg  ../../data/models/yolov4_608_coco_fp32.bmodel 4 0 0.5 0.45
...
```
- then put yolo_test.arm, configs dir with `.cfg`  and data dir on SE5

```shell
$ realpath ../../data/images/* > imagelist.txt
$ ./yolo_test.arm image imagelist.txt ${configs}/yolov4.cfg ../../data/models/yolov4_608_coco_fp32.bmodel 4 0 0.5 0.45 
